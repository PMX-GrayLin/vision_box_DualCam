...
int ios_readjsonfile1(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd1.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd1.json\n");
        return 1;
    }
...
int ios_readjsonfile1_1(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd1_1.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd1_1.json\n");
        return 1;
    }
...
int ios_readjsonfile2(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd2.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd2.json\n");
        return 1;
    }
...
int ios_readjsonfile3(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd3.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd3.json\n");
        return 1;
    }
...
int ios_readjsonfile4(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd4.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd4.json\n");
        return 1;
    }
...
int ios_readjsonfile5(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd5.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd5.json\n");
        return 1;
    }
...
int ios_readjsonfile6(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd6.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd6.json\n");
        return 1;
    }
...
int ios_readjsonfile7(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd7.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd7.json\n");
        return 1;
    }
...
int ios_readjsonfile8(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd8.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd8.json\n");
        return 1;
    }
...
int ios_readjsonfile9(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd9.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd9.json\n");
        return 1;
    }
...
int ios_readjsonfile10(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd10.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd10.json\n");
        return 1;
    }
...
int ios_readjsonfile11(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd11.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd11.json\n");
        return 1;
    }
...
int ios_readjsonfile12(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd12.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd12.json\n");
        return 1;
    }
...
int ios_readjsonfile13(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd13.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd13.json\n");
        return 1;
    }
...
int ios_readjsonfile14(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd14.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd14.json\n");
        return 1;
    }
...
int ios_readjsonfile15(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd15.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd15.json\n");
        return 1;
    }
...
int ios_readjsonfile16(char *jstring)
{
    ...
    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd16.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd16.json\n");
        return 1;
    }
...
int ios_readjsonfile41(char *jstring)
{
    FILE *file;
    char *buffer;
    long file_size;

    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd41.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd41.json\n");
        return 1;
    }
...
int ios_readjsonfile_ng(char *jstring)
{
    FILE *file;
    char *buffer;
    long file_size;

    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd_ng.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd_ng.json\n");
        return 1;
    }
...
int ios_readjsonfile_pass(char *jstring)
{
    FILE *file;
    char *buffer;
    long file_size;

    file = fopen("/home/user/primax/vision_box_DualCam/backend/json/backend_cmd_pass.json", "r");
    if (file == NULL)
    {
        printf("can't open /home/user/primax/vision_box_DualCam/backend/json/backend_cmd_pass.json\n");
        return 1;
    }
